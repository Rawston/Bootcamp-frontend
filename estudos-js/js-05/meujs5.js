 ...
 * Primitivos
 * 
 * Imutáveis (não podem ser alterados) e dados do nível mais baixo da linha.
 * 
 * - String type
 * - Number type
 * - Boolean type
...
console.log(typeof("Tipo de dados")) //- String type

console.log(typeof("2222.888")) //- Number type
